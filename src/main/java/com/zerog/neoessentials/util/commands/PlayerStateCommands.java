        ...
        d.register(Commands.literal("speed")
            ...
            .then(Commands.argument("speed", FloatArgumentType.floatArg(0f, 10f))
                ...
                .then(Commands.argument("playername", StringArgumentType.word())
                    ...
                    .executes(ctx -> executeSpeed(ctx, null, FloatArgumentType.getFloat(ctx, "speed"), StringArgumentType.getString(ctx, "playername")))
                )
            )
            ...
            .then(Commands.literal("walk")
                .then(Commands.argument("speed", FloatArgumentType.floatArg(0f, 10f))
                    ...
                    .then(Commands.argument("playername", StringArgumentType.word())
                        .suggests((ctx, b) -> SharedSuggestionProvider.suggest(ctx.getSource().getServer().getPlayerNames(), b))
                        .requires(src -> src.getPlayer() == null || PermissionAPI.hasPermission(src.getPlayer().getUUID(), "neoessentials.speed.others"))
                        .executes(ctx -> executeSpeed(ctx, false, FloatArgumentType.getFloat(ctx, "speed"), StringArgumentType.getString(ctx, "playername")))
                    )
                )
            )
            ...
            .then(Commands.literal("fly")
                .then(Commands.argument("speed", FloatArgumentType.floatArg(0f, 10f))
                    ...
                    .then(Commands.argument("playername", StringArgumentType.word())
                        .suggests((ctx, b) -> SharedSuggestionProvider.suggest(ctx.getSource().getServer().getPlayerNames(), b))
                        .requires(src -> src.getPlayer() == null || PermissionAPI.hasPermission(src.getPlayer().getUUID(), "neoessentials.speed.others"))
                        .executes(ctx -> executeSpeed(ctx, true, FloatArgumentType.getFloat(ctx, "speed"), StringArgumentType.getString(ctx, "playername")))
                    )
                )
            )
        );
            ...
            .then(Commands.literal("set")
                ...
                .then(Commands.argument("amount", IntegerArgumentType.integer(0))
                    ...
                    .then(Commands.argument("playername", StringArgumentType.word())
                        ...
                        .executes(ctx -> executeExpSet(ctx, IntegerArgumentType.getInteger(ctx, "amount"), StringArgumentType.getString(ctx, "playername")))
                    )
                )
            )
            ...
            .then(Commands.literal("give")
                ...
                .then(Commands.argument("amount", IntegerArgumentType.integer(1))
                    ...
                    .then(Commands.argument("playername", StringArgumentType.word())
                        ...
                        .executes(ctx -> executeExpGive(ctx, IntegerArgumentType.getInteger(ctx, "amount"), StringArgumentType.getString(ctx, "playername")))
                    )
                )
            )
        );
